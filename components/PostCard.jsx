...
const PostCard = ({post}) => {
    ...
    return (
        <div className={styles.container}>
            ...
            <Link style={{cursors: 'pointer'}} passHref href={`/profile/${post.user._id}`}>
                <Image className={styles.userImg} loader={post.user.img ? () => post.user.img : () => defaultSrc} src={post.user.img ?  post.user.img : defaultSrc} alt="" width={40} height={40} />
            </Link>
                <div className={styles.descContainer}>
                    <span className={styles.moreInfo}><b style={{color: 'black'}}>{post.user.username}</b> @{post.user.username}· 22m</span>
